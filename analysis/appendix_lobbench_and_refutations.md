...
Per-day, per-metric Wasserstein distance to real market data (lower = more realistic). `sim time` is
the wall-clock time to generate that day's 30-minute session (from the elimination-search logs,
`ckpt_search/long_20260729_145408_progress.csv`) — see §E of `appendix_checkpoint_evidence.md` for why
this varies by day (it tracks generated market activity, not day difficulty per se).

| Day | sim time | spread | inter-arrival | book imbalance | flow imbalance | limit depth | cancel depth |
|---|---|---|---|---|---|---|---|
| 2015-01-02 | 27:30 | 0.718 | 0.559 | 0.525 | 0.624 | 0.228 | 0.194 |
| 2015-01-05 | 28:59 | 0.719 | 0.453 | 0.356 | 0.688 | 0.219 | 0.194 |
| 2015-01-06 | 8:39 | 0.677 | 0.720 | 0.471 | 0.664 | 0.139 | 0.094 |
| 2015-01-07 | 29:18 | 0.654 | 0.410 | 0.464 | 0.820 | 0.246 | 0.176 |
| 2015-01-08 | 28:44 | 0.655 | 0.407 | 0.483 | 0.760 | 0.255 | 0.131 |
| 2015-01-09 | 25:46 | 0.837 | 0.525 | 0.428 | 0.811 | 0.194 | 0.159 |
| 2015-01-12 | 26:31 | 0.645 | 0.506 | 0.369 | 0.815 | 0.178 | 0.152 |
| 2015-01-13 | 13:08 | 0.748 | 0.843 | 0.368 | 0.748 | 0.157 | 0.142 |
| 2015-01-14 | 13:02 | 0.720 | 0.824 | 0.384 | 0.662 | 0.200 | 0.213 |
| 2015-01-15 | 8:52 | 0.864 | 0.877 | 0.364 | 0.641 | 0.253 | 0.387 |
| 2015-01-16 | 16:47 | 0.591 | 0.812 | 0.350 | 0.507 | 0.154 | 0.097 |
| 2015-01-20 | 13:21 | 0.710 | 0.763 | 0.464 | 0.623 | 0.133 | 0.098 |
| 2015-01-21 | 13:16 | 0.954 | 0.816 | 0.429 | 0.567 | 0.231 | 0.187 |
| 2015-01-22 | 18:27 | 0.759 | 0.691 | 0.439 | 0.652 | 0.204 | 0.126 |
| 2015-01-23 | 29:37 | 0.746 | 0.448 | 0.509 | 0.664 | 0.245 | 0.147 |
| 2015-01-26 | 22:22 | 0.708 | 0.584 | 0.533 | 0.601 | 0.217 | 0.149 |
| 2015-01-27 | 30:15 | 0.608 | 0.507 | 0.367 | 0.636 | 0.196 | 0.131 |
| 2015-01-28 | 20:55 | 0.727 | 0.655 | 0.446 | 0.635 | 0.204 | 0.138 |
| 2015-01-29 | 29:23 | 0.706 | 0.434 | 0.500 | 0.686 | 0.179 | 0.142 |
| 2015-01-30 | 16:54 | 0.625 | 0.671 | 0.384 | 0.664 | 0.172 | 0.164 |
| **mean** | **21:05** | **0.719** | **0.625** | **0.432** | **0.673** | **0.200** | **0.161** |
